...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.htmx.some_setting = some_default_value


## Developer installation

To install ckanext-htmx for development, activate your CKAN virtualenv and
do:
...
## Releasing a new version of ckanext-htmx

If ckanext-htmx should be available on PyPI you can follow these steps to publish a new version:
